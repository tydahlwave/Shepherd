...
int TextureLoader::ImageLoad(const char *filename, Image *image) {
	FILE *file;
...
void TextureLoader::init(TextureLoader::Image &image)
{
...
{
	TextureLoader::Image *image0 = (TextureLoader::Image *)malloc(sizeof(TextureLoader::Image));
	if(image0 == NULL) {
		printf("Error allocating space for image");
	}
	if(!TextureLoader::ImageLoad(filename.c_str(), image0)) {
